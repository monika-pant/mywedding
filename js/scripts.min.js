function init() {
    for (var myLatlng = new google.maps.LatLng(30.0815,80.3659), mapOptions = {
            zoom: 14,
            center: myLatlng,
            scrollwheel: !1,
            }, mapElement = document.getElementById("map"), map = new google.maps.Map(mapElement, mapOptions), addresses = ["Pithoragarh"], x = 0; x < addresses.length; x++) $.getJSON("http://maps.googleapis.com/maps/api/geocode/json?address=" + addresses[x] + "&sensor=false", null, function (data) {
        var p = data.results[0].geometry.location,
            latlng = new google.maps.LatLng(29.5849215,80.2053378);
...
function (e) {
    ...
    function () {
        ...
        var isiPad = function () {
            ...
            offcanvas = function () {
                ...
                $clone.attr({
                    ...
                    class: "",
                    id: ""
                }), $("#auro-home").prepend($clone), $(".js-auro-nav-toggle").on("click", function () {
                    $("body").hasClass("auro-offcanvas") ? $("body").removeClass("auro-offcanvas") : $("body").addClass("auro-offcanvas")
                }), $("#offcanvas-menu").css("height", $(window).height()), $(window).resize(function () {
                    var w = $(window);
                    $("#offcanvas-menu").css("height", w.height()), w.width() > 769 && $("body").hasClass("auro-offcanvas") && $("body").removeClass("auro-offcanvas")
                })
            },
            mobileMenuOutsideClick = function () {
                $(document).click(function (e) {
                    var container = $("#offcanvas-menu, .js-auro-nav-toggle");
                    container.is(e.target) || 0 !== container.has(e.target).length || $("body").hasClass("auro-offcanvas") && $("body").removeClass("auro-offcanvas")
                })
            },
            ...
            countDownDate = new Date("January 25, 2019 18:00:00").getTime(),
        ...
        $(function () {
            parallax(), offcanvas(), mobileMenuOutsideClick(), contentWayPoint(), stickyBanner()
        })
    }();
var google;
...
function (t) {
    ...
    function () {
        ...
        var t = function () {
            ...
            o = function () {
                var t = $("#auro-menu-wrap").clone();
                t.attr({
                    id: "offcanvas-menu"
                }), t.find("> ul").attr({
                    class: "",
                    id: ""
                }), $("#auro-home").prepend(t), $(".js-auro-nav-toggle").on("click", function () {
                    $("body").hasClass("auro-offcanvas") ? $("body").removeClass("auro-offcanvas") : $("body").addClass("auro-offcanvas")
                }), $("#offcanvas-menu").css("height", $(window).height()), $(window).resize(function () {
                    var t = $(window);
                    $("#offcanvas-menu").css("height", t.height()), t.width() > 769 && $("body").hasClass("auro-offcanvas") && $("body").removeClass("auro-offcanvas")
                })
            },
            r = function () {
                $(document).click(function (t) {
                    var e = $("#offcanvas-menu, .js-auro-nav-toggle");
                    e.is(t.target) || 0 !== e.has(t.target).length || $("body").hasClass("auro-offcanvas") && $("body").removeClass("auro-offcanvas")
                })
            },
            s = function () {
                var t = 0;
